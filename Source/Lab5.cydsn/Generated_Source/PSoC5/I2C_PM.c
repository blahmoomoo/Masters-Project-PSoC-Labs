...
I2C_BACKUP_STRUCT I2C_backup =
{
    I2C_DISABLE, /* enableState */
        ...
        #if(CY_PSOC5A)
            LO8(I2C_DEFAULT_DIVIDE_FACTOR),  /* div */
        #else
            LO8(I2C_DEFAULT_DIVIDE_FACTOR), /* div1 */
            HI8(I2C_DEFAULT_DIVIDE_FACTOR), /* div2 */
        #endif /* (CY_PSOC5A) */
        ...
        #if(CY_UDB_V0)
            I2C_INT_ENABLE_MASK, /* aux_ctl */

            #if(I2C_MODE_SLAVE_ENABLED)
                I2C_DEFAULT_ADDR, /* addr_d0 */
            #endif /* (I2C_MODE_SLAVE_ENABLED) */
        #endif /* (CY_UDB_V0) */
        ...
        I2C_DEFAULT_TMOUT_INTR_MASK,
            ...
            I2C_DEFAULT_TMOUT_PRESCALER_PRD,
        #endif /* (I2C_TIMEOUT_PRESCALER_ENABLED) */
