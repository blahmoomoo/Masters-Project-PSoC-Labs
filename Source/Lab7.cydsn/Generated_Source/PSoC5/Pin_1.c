...
void Pin_1_SetDriveMode(uint8 mode) 
{
	...
	CyPins_SetPinDriveMode(Pin_1_2, mode);
	CyPins_SetPinDriveMode(Pin_1_3, mode);
	CyPins_SetPinDriveMode(Pin_1_4, mode);
	CyPins_SetPinDriveMode(Pin_1_5, mode);
	CyPins_SetPinDriveMode(Pin_1_6, mode);
	CyPins_SetPinDriveMode(Pin_1_7, mode);
}
