...
void Pin_2_SetDriveMode(uint8 mode) 
{
	...
	CyPins_SetPinDriveMode(Pin_2_1, mode);
	CyPins_SetPinDriveMode(Pin_2_2, mode);
	CyPins_SetPinDriveMode(Pin_2_3, mode);
	CyPins_SetPinDriveMode(Pin_2_4, mode);
	CyPins_SetPinDriveMode(Pin_2_5, mode);
	CyPins_SetPinDriveMode(Pin_2_6, mode);
	CyPins_SetPinDriveMode(Pin_2_7, mode);
}
